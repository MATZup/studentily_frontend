      ...
      <div className="flex items-center justify-center h-screen w-screen">
        <div className="flex flex-col items-center w-full max-465:px-3 max-767:px-5">
          ...
          <div className="mt-12 flex w-full h-full items-center justify-center">
            <div
              id="custom_scrollbar"
              className="bg-[#191A27] overflow-y-auto max-640:mt-6 max-640:mx-0 between-767-960:max-h-[41rem] max-767:mt-6 max-767:h-[43rem] min-767:mx-[3.2rem] rounded-xl w-full max-w-[80rem] h-[39.9rem] p-4 md:p-7 flex flex-col md:flex-row justify-between"
            >
              <div
