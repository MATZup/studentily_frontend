...
export default function TodosPage() {
  ...
  return (
    <>
      ...
      <div className="flex mt-[6.3rem] flex-col items-center w-full px-10 max-900:px-4 max-500:px-1 max-385:px-0">
        <div className="max-h-[calc(90vh-8rem)] px-4 overflow-y-auto w-full max-w-[82rem] relative">
          {activeTodos.length > 0 ? (
            ...
            <div className="flex max-500:mt-2 flex-col justify-center items-center mx-auto mt-12">
              <img className="w-72" src={todosEmoji} alt="todos-mascot" />
              <span className="-mt-2 text-center">
                Create <b>Todos!</b> Just click the <b>Create Todo</b>{" "}
                Field below. <br />
